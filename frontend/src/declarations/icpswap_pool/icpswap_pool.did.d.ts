...
export type Result_18 =
	...
	| { err: Error };
export type Result_19 = { ok: Page_4 } | { err: Error };
export type Result_2 = { ok: boolean } | { err: Error };
export type Result_20 = { ok: PositionInfo } | { err: Error };
export type Result_21 = { ok: CycleInfo } | { err: Error };
export type Result_22 = { ok: { amount0: bigint; amount1: bigint } } | { err: Error };
export type Result_23 =
	...
	| { err: Error };
export type Result_24 = { ok: Page_5 } | { err: Error };
...
export type Result_6 = { ok: Array<[bigint, WithdrawErrorLog]> } | { err: Error };
...
export interface SwapPool {
	allTokenBalance: ActorMethod<[bigint, bigint], Result_24>;
	approvePosition: ActorMethod<[Principal, bigint], Result_2>;
	batchRefreshIncome: ActorMethod<[Array<bigint>], Result_23>;
	checkOwnerOfUserPosition: ActorMethod<[Principal, bigint], Result_2>;
	claim: ActorMethod<[ClaimArgs], Result_22>;
	decreaseLiquidity: ActorMethod<[DecreaseLiquidityArgs], Result_22>;
	...
	getCycleInfo: ActorMethod<[], Result_21>;
	getMistransferBalance: ActorMethod<[Token], Result>;
	getPosition: ActorMethod<[GetPositionArgs], Result_20>;
	getPositions: ActorMethod<[bigint, bigint], Result_19>;
